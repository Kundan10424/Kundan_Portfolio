...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className='absolute  xs:bottom-7
       bottom-3 w-full flex justify-end right-10 items-center'>
        <a href='#about'>
